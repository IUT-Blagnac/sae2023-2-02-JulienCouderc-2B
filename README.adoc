...
| 1    | link:https://github.com/IUT-Blagnac/sae2023-2-02-JulienCouderc/blob/main/src/main/java/exercice/ExerciceEfficaceMeilleur.java[meilleur java]| Java     | Efficacité | Meilleur
| 2    | link:https://github.com/IUT-Blagnac/sae2023-2-02-JulienCouderc/blob/main/src/main/java/exercice/ExerciceEfficacePire.java[pire java]| Java     | Efficacité | Pire
| 3    | link:https://github.com/IUT-Blagnac/sae2023-2-02-JulienCouderc/blob/main/src/main/java/exercice/ExerciceSimpliciteMeilleur.java[Meilleur java]    | Java     | Simplicité | Meilleur
| 4    | link:https://github.com/IUT-Blagnac/sae2023-2-02-JulienCouderc/blob/main/src/main/java/exercice/ExerciceSimplicitePire.java[pire java]    | Java     | Simplicité | Pire
| 5    | link:https://github.com/IUT-Blagnac/sae2023-2-02-JulienCouderc/blob/main/src/main/java/exercice/ExerciceSobrieteMeilleur.java[Meilleur java]    | Java     | Sobriété | Meilleur
| 6    | link:https://github.com/IUT-Blagnac/sae2023-2-02-JulienCouderc/blob/main/src/main/java/exercice/ExerciceSobrietePire.java[Pire java]    | Java     | Sobriété | Pire
| ...  | ...                                                     | ...      | ...      
|==========================================================================
...
. Veuiller récupérer la classe codeTests.java dans le répertoire analyse et le mettre dans le répertoire src/test/java
...
. Veuiller récupérer la classe codeEvaluationClassement.java dans le répertoire analyse et la mettre dans le répertoire src/test/java
